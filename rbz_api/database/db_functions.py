...
def set_vote(device_uuid, username, recommendation_id, movie_id, vote):
    try:
        ...
        voteModel = VoteModel.query.filter(VoteModel.device_uuid == device_uuid, VoteModel.user_id == id, VoteModel.recommendation_id == recommendation_id, VoteModel.movie_id == movie_id).first()
