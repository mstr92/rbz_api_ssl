...
movie = api.model('Movies', {
    ...
    'neg_year_from': fields.Integer(min=MIN_YEAR, max=MAX_YEAR, description='List of negative years from'),
    'pos_year_from': fields.Integer(min=MIN_YEAR, max=MAX_YEAR, description='List of positive years from'),
    'neg_year_to': fields.Integer(min=MIN_YEAR, max=MAX_YEAR, description='List of negative years to'),
    'pos_year_to': fields.Integer(min=MIN_YEAR, max=MAX_YEAR, description='List of positive years to'),
